        ...
        bool CreateMinSpanTree_Kruskal() {
            ...
            */
            for (int i = 0; i < edgecount; ++i) {
                cout << pm_VecticesList[pedge[i].idx_startVert] << "---->" << pm_VecticesList[pedge[i].idx_endVert]
                     << " : 权值=" << pedge[i].weight << endl;
            }
            cout << "--------------------------" << endl;
            ...
            */
            ...
            while (iSelEdgeCount < (m_numVertices - 1)) {
                ...
                if (pLinkSign[idxS] == -1 && pLinkSign[idxE] == -1) {
                    ...
                    cout << pm_VecticesList[idxS] << "--->" << pm_VecticesList[idxE] << " : 权值="
                         << pedge[iCurEdgeIdx].weight << endl; //显示边和权值信息
                } else {
